...
build:
	...
	@cp node_modules/knovator-quill/dist/quill.core.css dist
	@cp node_modules/knovator-quill/dist/quill.snow.css dist
	@cp node_modules/knovator-quill/dist/quill.bubble.css dist
	@mkdir -p $(LIB)
	@cp -Rfv $(SOURCE)/* $(LIB)
